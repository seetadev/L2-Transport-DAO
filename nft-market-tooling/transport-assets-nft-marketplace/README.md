...
Optimism NFT marketplace devtooling for enabling sharing of government R&D assets and service/repair of transport assets. We are extending and building the nft marketplace using lost and found NFT marketplace [1] example tempalte build on Optimism. Optimism NFT marketplace for NFC tags of UAVs for enabling sharing of government assets and service/repair of vital assets.
...
> Install
```
cd transport-optimism-marketplace
yarn install
```
...
```
cd transport-optimism-marketpalce
yarn build
yarn surge
```
