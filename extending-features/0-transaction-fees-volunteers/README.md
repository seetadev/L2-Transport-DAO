# Giving free Optimism transactions to volunteers sharing anonymized report data 

We are extending OpenGSN [1] and Optimism module [2] to enable 0 Optimism transaction fees for volunteers sharing anonymized report data using PyTorch open source library.
